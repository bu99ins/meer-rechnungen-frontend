...
Reference documentation for `meer-rechnungen-frontend`. These pages hold the detailed material
that was moved out of [CLAUDE.md](../CLAUDE.md) (which stays lean, for AI-assistant context);
start there for the high-level architecture and command reference.

| Page | Contents |
|------|----------|
| [project-structure.md](project-structure.md) | Technology stack, dependency summary, source tree layout |
